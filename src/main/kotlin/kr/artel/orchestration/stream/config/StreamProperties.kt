...
data class StreamProperties(
     ...
     * 탭의 타이머를 조이고, 가장 나쁜 경우가 1분에 1회다(탭이 5분쯤 숨겨진 뒤부터. 그 전까지는
     * 1초에 1회라 짧은 임대도 버틴다 — 고장이 간헐적으로 보였던 이유다). 그 주기를 못 넘는
     * 임대는 배경에 오래 둔 탭을 매 주기 잘라낸다. 기본값은 그 1분에 스케줄링 드리프트와 전송
     * 지연을 얹을 여유를 더해 잡혀 있다.
     *
    ...
    private companion object {
         ...
         * 되는가**다. 그래서 [lease]가 기준으로 삼는 조여진 갱신 주기에서 나온다 — 그것을 못
         * 넘기면 유실 허용 폭이 0이고, 여기 값은 폭이 존재하기 시작하는 첫 지점이다.
         *
