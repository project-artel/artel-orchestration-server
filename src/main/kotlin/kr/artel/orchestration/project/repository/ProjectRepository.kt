...
interface ProjectRepository : ReactiveCrudRepository<ProjectEntity, Long> {
    ...
    fun findPageForMember(userId: Long, limit: Int, offset: Long): Flux<ProjectEntity>
    ...
    fun countForMember(userId: Long): Mono<Long>
    ...
    fun findAccessibleById(id: Long, userId: Long): Mono<ProjectEntity>
}
